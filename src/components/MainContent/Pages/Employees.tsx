...
const CreateLinkToInfo = (key: string, value: string) => {
    ...
    switch (key) {
        ...
        case 'email':
            ...
            break;
        case 'place':
            value.includes('L') ? link = "https://en.mapy.cz/s/posaparapu" : link = "https://en.mapy.cz/s/jemasahuso";
            target = "_blank";
            break;
            ...
            <div>
                ...
                <div className="positionInfo">
                    ...
                    <div className="contactBlocks">
                        {Object.entries(person).map(elem => GetContactsBlock({
                            info: elem[1],
                            key: elem[0]
                        }))}
                    </div>
...
const Employees = () => {
    ...
    const EmployeesObject: IEmployees = t('main.employees', {returnObjects: true});
