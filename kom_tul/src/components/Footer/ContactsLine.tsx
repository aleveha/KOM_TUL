                ...
                <div className="contactInformation">
                    ...
                    <div className="addressAndContacts">
                        ...
                        <div className="contacts">
                            <div>
                                <p className="linkPar secondText"><a className="link" href="tel:+420485353361">+420 48
                                    535
                                    3361</a></p>
                                <p className="linkPar secondText"><a className="link"
                                                                     href="mailto:tereza.vrbova@tul.cz">tereza.vrbova@tul.cz</a>
                                </p>
                                <p className="linkPar secondText"><Link className="link"
                                                                        to="/home">www.kom.tul.cz</Link>
                                </p>
                            </div>
                        </div>
                    </div>
